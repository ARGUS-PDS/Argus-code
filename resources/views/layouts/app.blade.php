...
<head>
  <<<<<<< HEAD <meta charset="UTF-8">
    ...
    >>>>>>>a017d68189e2f6de854899a399b4735a7eadc9d6 @include('layouts.css-variables') <style>* {
      margin: 0;
      padding: 0;
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <div class="navbar-right-items">
          <div class="user-info position-relative">
            ...
            <<<<<<< HEAD <div id="userMenuPanel" class="user-menu-panel shadow text-center">
                ...
                <div class="navbar-right-items">
                  <div class="user-info position-relative">
                    ...
                    <div id="userMenuPanel" class="user-menu-panel shadow text-center">
                      ...
                      >>>>>>> a017d68189e2f6de854899a399b4735a7eadc9d6
          ...
          <form id="formAlterarSenha" action="{{ route('change-password') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="password-container position-relative" id="newPasswordContainer">
                ...
                <span class="validation-icon" id="new_password_validation">
                </span>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="password-container position-relative" id="confirmPasswordContainer">
                ...
                <i class="bi bi-eye toggle-password" onclick="togglePassword(this)"></i>
                <span class="validation-icon" id="confirm_password_validation">
                </span>
              </div>
