...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/create-company.css') }}">
...
<body>
  <div class="container-card">
    ...
    <form action="{{ route('companies.store') }}" method="POST" id="formEmpresa">
      @csrf
      ...
      <div class="section-card">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <div class="email-feedback invalid" id="emailFeedback">Por favor, insira um email válido</div>
          </div>
