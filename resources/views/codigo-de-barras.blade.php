...
<div class="container my-5">
  ...
  <form id="formCadastroProduto" class="border p-4 bg-white rounded d-none" novalidate>
    ...
    <div class="form-row">
      ...
      <div class="col-md-8">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="valorVenda" placeholder="Valor de venda" min="0" step="0.01" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="lucro" placeholder="Lucro" min="0" step="0.01" />
        </div>
        <div class="form-group">
        ...
        <div class="form-check mb-3">
          <input type="checkbox" class="form-check-input" id="situacao" />
